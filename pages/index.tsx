...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: "    name: 'Vipul Bhatt',", type: 'array-item' },
    { code: "    role: 'Full Stack Developer',", type: 'array-item' },
    { code: "    bio: 'Building scalable web apps & AI-powered solutions'", type: 'array-item' },
    { code: '  };', type: 'array-end' },
    { code: '', type: 'blank' },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <h1 className={styles.developerName}>
            Vipul <span className={styles.accentText}>Bhatt</span>
          </h1>

          <div className={styles.developerRole}>Full Stack Developer | AI Enthusiast</div>

          <p className={styles.bio}>
            I build scalable, responsive web applications with MERN stack and AI integrations.
            Focused on clean code, system design, and delivering impactful solutions.
          </p>
